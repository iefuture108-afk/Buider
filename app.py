...
# 1. Setup Gemini configuration via Secrets
genai.configure(api_key=st.secrets["GEMINI_API_KEY"])

def generate_ai_look(uploaded_file, vibe, style):
    """Uses Gemini for clean face analysis, and Pollinations for free image generation."""
    ...
    with st.spinner("Gemini is analyzing your facial features..."):
        ...
        try:
            ...
            # Clean up any potential special characters that break URL structures
